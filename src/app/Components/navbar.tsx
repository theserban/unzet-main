          ...
          <div className="flex flex-col items-start space-y-4">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="flex items-center justify-between w-full px-2 py-2 text-base font-semibold leading-7 text-white rounded-tr-lg rounded-bl-lg cursor-pointer hover:text-black hover:bg-primary-500"
                onClick={() => setMobileMenuOpen(false)}
              >
