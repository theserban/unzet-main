...
import { CloudArrowUpIcon, LockClosedIcon, ServerIcon, TrophyIcon, MapIcon, CheckIcon, ArrowPathIcon, MinusIcon } from '@heroicons/react/24/outline';
...
const Card = ({ icon: Icon, title, power, description, pills }) => (
